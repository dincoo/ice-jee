...
import org.ice.jee.spring.common.core.exception.BaseException;
import org.ice.jee.spring.common.core.exception.IllegalParameterException;
import org.ice.jee.spring.common.core.pager.Pager;
import org.ice.jee.spring.common.core.support.HttpCode;
import org.ice.jee.spring.common.core.util.InstanceUtil;
import org.ice.jee.spring.web.core.util.WebUtil;
...
//		try {
//			Class clazz = Class.forName("com.hulian.ff.cloud.web.entity.User");
//			Object obj = clazz.newInstance();
//			Field fId = clazz.getDeclaredField("id");
//			fId.setAccessible(true);
//			fId.set(obj, 332098966662932993L);
//			return obj;
...
//		return null;
	...
	protected abstract void exceptionHandler(Exception ex, ModelMap modelMap);
}
